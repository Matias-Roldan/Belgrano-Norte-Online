...
function Dropdown({ label, labelId, opciones, valorKey, textoKey, value, onChange, placeholder, acento, deshabilitado }) {
  ...
  // [SEC-FIX] Validar que el valor elegido existe en las opciones antes de propagar
...
function DropdownHora({ label, labelId, value, onChange, placeholder }) {
  ...
  // [SEC-FIX] Validar que el valor está en la allowlist HORAS_VALIDAS
  const handleChange = (val) => {
...
export default function Planificar() {
  ...
  useEffect(() => {
    ...
    Promise.all([api.get('/estaciones'), api.get('/dias')])
      .then(([e, d]) => {
        if (!activo) return;
        // [SEC-FIX] Validar y sanitizar estaciones y días
  ...
  const buscar = useCallback(async () => {
    ...
    // [SEC-FIX] Validar todos los parámetros antes de enviar
    ...
    try {
      const res = await api.get('/horarios-rango', {
        params: {
          idOrigen:  idOrigen,   // [SEC-FIX] enteros validados
          idDestino: idDestino,
          idDia:     idDia,
          Inicio:    horaInicio, // [SEC-FIX] validados contra HORAS_VALIDAS
          Fin:       horaFin,
        },
      });
      // [SEC-FIX] Validar y sanitizar trenes recibidos
  ...
  // [SEC-FIX] Todos los nombres ya sanitizados en validarEstacion/validarDia
    ...
    <div style={s.root}>
      ...
      <main style={s.main}>
        ...
        <div style={s.panel}>
          ...
          {/* [SEC-FIX] Aviso de horas sin emoji — SVG controlado */}
          {!horasValidas && (
        ...
        {/* [SEC-FIX] Error con role="alert" y texto plano */}
        {error && (
        ...
        {!cargando && buscado && resultados.length === 0 && (
          <div style={s.sinCard}>
            ...
            {/* [SEC-FIX] nombres ya sanitizados */}
            <div style={s.sinSub}>
          ...
          <div style={s.resultadosBox}>
            <div style={s.resHeader}>
              ...
              <div style={s.resMeta}>
                <div style={s.resDetalles}>
                  {/* [SEC-FIX] nombreDia ya sanitizado */}
            ...
            <div role="list" aria-label="Resultados de horarios">
              {resultados.map((tren, i) => {
                // [SEC-FIX] horarios ya validados con regex en validarTrenRango()
                ...
                return (
                  ...
                  >
                    ...
                    <div style={s.trenEstadoWrap}>
                      {/* [SEC-FIX] estado ya sanitizado en validarTrenRango() */}
